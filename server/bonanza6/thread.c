...
init_state( const tree_t * restrict parent, tree_t * restrict child )
{
  ...
  memcpy( child->list0, parent->list0, sizeof(parent->list0) );
  memcpy( child->list1, parent->list1, sizeof(parent->list1) );
  memcpy( child->curhand, parent->curhand, sizeof(parent->curhand) );
  memcpy( child->sq4listsuf, parent->sq4listsuf, sizeof(parent->sq4listsuf) );
  memcpy( child->listsuf4sq, parent->listsuf4sq, sizeof(parent->listsuf4sq) );
  child->nlist       = parent->nlist;
