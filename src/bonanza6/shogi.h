...
extern char trans_table_memory_name[ 256 ]; // 共有メモリの共有名
#endif
...
void CONV hash_store_pv( const tree_t * restrict ptree, move_t move,
                         int turn );
...
void CONV make_move_w( tree_t * restrict ptree, move_t move, int ply );
void CONV make_move_b( tree_t * restrict ptree, move_t move, int ply );
void CONV unmake_move_b( tree_t * restrict ptree, move_t move, int ply );
void CONV unmake_move_w( tree_t * restrict ptree, move_t move, int ply );
...
const char *str_CSA_move( move_t move );
...
#if defined(MNJ_LAN) || defined(USI)
extern move_t moves_ignore[MAX_LEGAL_MOVES];
#endif
