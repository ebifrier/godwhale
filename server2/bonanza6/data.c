// $Id: data.c,v 1.2 2012-04-06 08:11:32 eikii Exp $
...
#ifdef SHARED_HIST
SHARE unsigned short hist_tried[HIST_SIZE];
SHARE unsigned short hist_goodary[HIST_SIZE];
lock_t hist_lock[HIST_SIZE];
#endif
